  ...
  return (
    <section className="privacy">
      ...
      <ul className="privacy__list">
        ...
        <li>
          <p className="privacy__item">3.1. Оператор имеет право:</p>
        </li>
        <li>
          <p className="privacy__item">
        ...
        <li>
          <p className="privacy__item">3.2. Оператор обязан:</p>
        </li>
        <li>
          <p className="privacy__item">
        ...
        <li>
          <p className="privacy__item">5.1. Фамилия, имя, отчество.</p>
        </li>
        <li>
          <p className="privacy__item">5.2. Электронный адрес.</p>
        </li>
        <li>
          <p className="privacy__item">5.3. Номера телефонов.</p>
        </li>
        <li>
          <p className="privacy__item">
        ...
        <li>
          <p className="privacy__item">7. Цели обработки персональных данных</p>
        </li>
        <li>
          <p className="privacy__item">
        ...
        <li>
          <p className="privacy__item">
            ...
            материалам, содержащимся на веб-сайте https://github.com/alvde-site.
          </p>
        </li>
        <li>
          <p className="privacy__item">
            ...
            электронной почты Polinamirchevabrand@gmail.com с пометкой «Отказ от
        ...
        <li>
          <p className="privacy__item">
            ...
            https://github.com/alvde-site или направленные Оператору посредством
        ...
        <li>
          <p className="privacy__item">
            ...
            персональные данные). 10.7. Оператор при обработке персональных
            данных обеспечивает конфиденциальность персональных данных. 10.8.
            Оператор осуществляет хранение персональных данных в форме,
            позволяющей определить субъекта персональных данных, не дольше, чем
            этого требуют цели обработки персональных данных, если срок хранения
            персональных данных не установлен федеральным законом, договором,
            стороной которого, выгодоприобретателем или поручителем по которому
            является субъект персональных данных. 10.9. Условием прекращения
            ...
            субъекта персональных данных или отзыв согласия субъектом
            ...
            почты Polinamirchevabrand@gmail.com. 14.2. В данном документе будут
            ...
            сети Интернет по адресу https://github.com/alvde-site.
          </p>
        </li>
        <li>
          <p className="privacy__item">
        ...
        <li>
          <p className="privacy__item">
            ...
            Оператора Polinamirchevabrand@gmail.com с пометкой «Актуализация
            персональных данных».
          </p>
        </li>
        <li>
          <p className="privacy__item">
            ...
            Оператора Polinamirchevabrand@gmail.com с пометкой «Отзыв согласия
        ...
        <li>
          <p className="privacy__item">
            ...
            предусмотрено федеральным законом. 14. Заключительные положения
          </p>
        </li>
        <li>
          <p className="privacy__item">
